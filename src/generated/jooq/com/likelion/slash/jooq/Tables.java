...
public class Tables {
     ...
     */
    public static final AgentDispatches AGENT_DISPATCHES = AgentDispatches.AGENT_DISPATCHES;

    /**
     * SQS 로 전달하는 LLM 작업. Task 당 한 건.
     */
    public static final AsyncJobs ASYNC_JOBS = AsyncJobs.ASYNC_JOBS;

    /**
     * PC 등록 해제·권한 등 주요 변경 기록. 비밀값과 전체 파일 경로를 저장하지 않는다.
     */
    public static final AuditEvents AUDIT_EVENTS = AuditEvents.AUDIT_EVENTS;
     ...
     */
    public static final DeviceProjectWorkspaces DEVICE_PROJECT_WORKSPACES = DeviceProjectWorkspaces.DEVICE_PROJECT_WORKSPACES;

    /**
     * Agent 가 READY 프레임의 searchFolders 로 보고한 검색 폴더. 실제 경로는 받지 않는다.
     */
    public static final DeviceSearchFolders DEVICE_SEARCH_FOLDERS = DeviceSearchFolders.DEVICE_SEARCH_FOLDERS;
     ...
     */
    public static final IdempotencyRecords IDEMPOTENCY_RECORDS = IdempotencyRecords.IDEMPOTENCY_RECORDS;
     ...
     */
    public static final TaskEvents TASK_EVENTS = TaskEvents.TASK_EVENTS;
