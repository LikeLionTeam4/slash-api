...
public class Keys {
    ...
    public static final UniqueKey<DeviceProjectWorkspacesRecord> PK_DEVICE_PROJECT_WORKSPACES = Internal.createUniqueKey(DeviceProjectWorkspaces.DEVICE_PROJECT_WORKSPACES, DSL.name("pk_device_project_workspaces"), new TableField[] { DeviceProjectWorkspaces.DEVICE_PROJECT_WORKSPACES.DEVICE_ID, DeviceProjectWorkspaces.DEVICE_PROJECT_WORKSPACES.WORKSPACE_ID }, true);
    ...
    public static final UniqueKey<TaskApprovalsRecord> TASK_APPROVALS_PKEY = Internal.createUniqueKey(TaskApprovals.TASK_APPROVALS, DSL.name("task_approvals_pkey"), new TableField[] { TaskApprovals.TASK_APPROVALS.ID }, true);
    public static final UniqueKey<TaskApprovalsRecord> UK_TASK_APPROVALS_PUBLIC_ID = Internal.createUniqueKey(TaskApprovals.TASK_APPROVALS, DSL.name("uk_task_approvals_public_id"), new TableField[] { TaskApprovals.TASK_APPROVALS.PUBLIC_ID }, true);
    public static final UniqueKey<TaskApprovalsRecord> UK_TASK_APPROVALS_TASK = Internal.createUniqueKey(TaskApprovals.TASK_APPROVALS, DSL.name("uk_task_approvals_task"), new TableField[] { TaskApprovals.TASK_APPROVALS.TASK_ID }, true);
    ...
    public static final ForeignKey<DeviceProjectWorkspacesRecord, DevicesRecord> DEVICE_PROJECT_WORKSPACES__FK_DEVICE_PROJECT_WORKSPACES_DEVICE = Internal.createForeignKey(DeviceProjectWorkspaces.DEVICE_PROJECT_WORKSPACES, DSL.name("fk_device_project_workspaces_device"), new TableField[] { DeviceProjectWorkspaces.DEVICE_PROJECT_WORKSPACES.DEVICE_ID }, Keys.DEVICES_PKEY, new TableField[] { Devices.DEVICES.ID }, true);
    ...
    public static final ForeignKey<TaskApprovalsRecord, UsersRecord> TASK_APPROVALS__FK_TASK_APPROVALS_DECIDED_BY = Internal.createForeignKey(TaskApprovals.TASK_APPROVALS, DSL.name("fk_task_approvals_decided_by"), new TableField[] { TaskApprovals.TASK_APPROVALS.DECIDED_BY }, Keys.USERS_PKEY, new TableField[] { Users.USERS.ID }, true);
    public static final ForeignKey<TaskApprovalsRecord, TasksRecord> TASK_APPROVALS__FK_TASK_APPROVALS_TASK = Internal.createForeignKey(TaskApprovals.TASK_APPROVALS, DSL.name("fk_task_approvals_task"), new TableField[] { TaskApprovals.TASK_APPROVALS.TASK_ID }, Keys.TASKS_PKEY, new TableField[] { Tasks.TASKS.ID }, true);
