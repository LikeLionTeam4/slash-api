...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The column <code>public.users.public_id</code>. API 로 노출하는 식별자. 순차 ID 추측을
     * 방지한다.
     */
    public final TableField<UsersRecord, UUID> PUBLIC_ID = createField(DSL.name("public_id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("gen_random_uuid()"), SQLDataType.UUID)), this, "API 로 노출하는 식별자. 순차 ID 추측을 방지한다.");

    /**
     * The column <code>public.users.cognito_sub</code>. Cognito JWT 의 sub 클레임.
     */
    public final TableField<UsersRecord, String> COGNITO_SUB = createField(DSL.name("cognito_sub"), SQLDataType.VARCHAR(255).nullable(false), this, "Cognito JWT 의 sub 클레임.");
     ...
     */
    public final TableField<UsersRecord, String> DISPLAY_NAME = createField(DSL.name("display_name"), SQLDataType.VARCHAR(100), this, "");

    /**
     * The column <code>public.users.status</code>.
     */
    public final TableField<UsersRecord, String> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR(20).nullable(false).defaultValue(DSL.field(DSL.raw("'ACTIVE'::character varying"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>public.users.timezone</code>.
     */
    public final TableField<UsersRecord, String> TIMEZONE = createField(DSL.name("timezone"), SQLDataType.VARCHAR(64).nullable(false).defaultValue(DSL.field(DSL.raw("'Asia/Seoul'::character varying"), SQLDataType.VARCHAR)), this, "");
    ...
    private Users(Name alias, Table<UsersRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("서비스 이용자. Cognito sub 로 식별한다."), TableOptions.table(), where);
    }
    ...
    public DevicesPath devices() {
        if (_devices == null)
            _devices = new DevicesPath(this, null, Keys.DEVICES__FK_DEVICES_USER.getInverseKey());
    ...
    public List<Check<UsersRecord>> getChecks() {
        return Arrays.asList(
            Internal.createCheck(this, DSL.name("ck_users_status"), "(((status)::text = ANY ((ARRAY['ACTIVE'::character varying, 'SUSPENDED'::character varying, 'DELETED'::character varying])::text[])))", true)
        );
    }
